...
Python simple arp table reader could always use more documentation, whether as part of the
official Python simple arp table reader docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
3. The pull request should work for Python 2.6, 2.7, 3.3, and 3.4, and for PyPy. Check
   https://travis-ci.org/XayOn/python_arptable/pull_requests
